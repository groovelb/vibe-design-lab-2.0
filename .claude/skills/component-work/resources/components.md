...
- DynamicTagConstruct: HTML 태그 생성 시각화 모션 컨테이너. 중앙 태그 등장 → 4꼭지점 앵커 분산 → 윤곽선 드로잉 → 콘텐츠 페이드인. CSS transition 기반, IntersectionObserver 자동 트리거 (`components/motion/DynamicTagConstruct.jsx`)
