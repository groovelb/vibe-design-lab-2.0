...
export const PAGES = {
  ...
  landing: {
    hero: {
      ...
      painPoints: [
        { label: '의도를 설명할수록 산으로 갑니다', text: '의도를 전달하려 문장을 덧붙일수록 AI는 더 엉뚱한 방향으로 갑니다. 말이 길어지는 건 설계가 없다는 신호입니다.' },
        { label: '원하는 걸 AI에게 설명이 안 됩니다', text: '머릿속에 있는 디자인을 전달할 단어가 없습니다. 같은 말을 반복해도 매번 다른 결과가 나옵니다.' },
        { label: '고치는 시간이 만드는 시간보다 깁니다', text: '만들어달라고 한 시간보다 고쳐달라고 한 시간이 더 깁니다. 수정이 반복될수록 처음부터 다시 만드는 게 빠릅니다.' },
      ],
    },
    problem: {
