...
export const PAGES = {
  ...
  landing: {
    hero: {
      headline: '바이브 코딩, 내맘대로 되고 있나요?',
      painPoints: [
        { label: '의도를 설명할수록 산으로 갑니다', text: '말이 길어질수록 AI는 산으로 갑니다. 설계 없는 프롬프트의 한계입니다. 설계가 있으면 프롬프트는 짧아집니다.' },
        { label: '원하는 걸 AI에게 설명이 안 됩니다', text: '원하는 디자인을 설명할 단어가 없습니다. 무슨 말을 할지 매번 생각합니다. 어휘가 있으면 한 마디로 전달됩니다.' },
        { label: '고치는 시간이 만드는 시간보다 깁니다', text: '만드는 것보다 고치는 데 시간이 더 듭니다. 코드는 몰라도, 작업할 범위를 언어로 표현하는 연습이 필요합니다.' },
      ],
    },
    problem: {
      headline: '대체 가능한 포지션, 독립조차 두려운 불안감.\n바이브 디자인은 AI가 대체 못하는 빌더가 되기 위한 도구입니다.',
      tags: ['디자이너', '개발자', '직장인', '프리랜서', '솔로프리너'],
      career: [
        {
          subtitle: '피그마 밖에서는 존재감을 잃어버린 심정입니다',
          text: '결정권이 피그마 안에서만 존재합니다. 넘기는 순간 대체 가능한 포지션이 됩니다. 캔버스를 뛰어넘는 디자인 엔지니어가 생존합니다.',
        },
        {
          subtitle: '보여줄 게 없으면 말로는 한계입니다',
          text: '설득의 도구가 기획서와 말뿐입니다. 점점 의사결정 테이블에서 밀려납니다. 직접 증명하고 기술적 공감대를 주는 PM이 주목받습니다.',
        },
        {
          subtitle: '시키는 것만 하다 파이프라인의 부품이 된 느낌입니다',
          text: '기획서대로, 디자인대로 구현만 반복합니다. 스스로 판단하고 결정하는 근육이 사라집니다. 파이프라인의 부품은 언제든 교체됩니다.',
        },
      ],
    ...
    howDifferent: {
      headline: '디자인과 개발을 잇는 언어를 배웁니다',
      subCopy: '사고와 구현이 별개라는 편견은 커리어를 고립시킵니다',
      details: [
        {
          tabLabel: 'Design Context',
          headline: '기준이 있으면 AI가 흔들리지 않는다',
          description:
            '기획서·UX 플로우·레퍼런스 보드가 AI의 설계 맥락이 됩니다. 의도와 구현 사이의 거리가 줄어듭니다.',
        },
        {
          tabLabel: 'Design Taxonomy',
          headline: '이름을 붙이면, 결과가 일관됩니다',
          description:
            '히어로 섹션, 카드 그리드, Bento 레이아웃 — 명명된 패턴은 AI에게도 동료에게도 같은 결과를 만듭니다.',
        },
        {
          tabLabel: 'Meta-language',
          headline: '설계의 상세도가 제품의 완성도를 결정한다',
          description:
            'UX 시나리오의 깊이가 데이터 모델과 API 구조를 결정합니다. 디자인은 화면의 일부가 아니라, 제품 전체를 설계하는 메타언어입니다.',
        },
      ],
    },
    learningMethod: {
