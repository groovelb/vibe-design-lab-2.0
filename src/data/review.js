import review1 from '../assets/reivew/review-1.gif';
import review7 from '../assets/reivew/review-7.webp';
import review8 from '../assets/reivew/review-8.webp';
import review9 from '../assets/reivew/review-9.webp';

const review2 = '/video/review-2.mp4';
const review3 = '/video/review-3.mp4';
const review4 = '/video/review-4.mp4';
const review5 = '/video/review-5.mp4';
const review6 = '/video/review-6.mp4';
...
const courseReviews = [
  ...
  },
  {
    ...
    company: '',
    image: review2,
    content: '회사에서 반복되는 디자이너의 작업을 어떻게 효율적으로 할 수 있을지 고민하다 이 코스를 듣게되었는데 처음 부터 스토리북 & 디자인 시스템으로 작업하는 방식을 터득해서 좋았습니다. 사내에서도 디자인 시스템을 리드하는 프로젝트를 맡게되었습니다!',
    recommender: 'Data Driven Design 대표 DDD',
  },
  {
    name: '조XX',
  ...
  },
  {
    ...
    company: 'IT 솔루션 회사',
    image: review4,
    content: '디자인시스템의 기초와 중요성을 알려주신게 가장 좋았다. 디자인 중심 개발이란 개념이생소했지만 웹 개발 측면에서 가장 필요하고 0번째로 이루어져야하는게 디자인이고 퍼블이라는걸 깨닫고, 디자인시스템이 잘 수립되어 있으면 개발자와 디자이너의 커뮤니케이션 간극도 줄어들것 같다는 생각이 들게해주셔서 흥미로웠다.',
    recommender: 'Data Driven Design 대표 DDD',
  },
  {
    name: '민XX',
  ...
  },
  {
    ...
    company: '',
    image: review6,
    content: '수업 내용도 알찼지만 여러모로 ddd 님의 철학과 창조적인 방법론들도 엿볼 수 있어서 흥미롭고 감명깊었던 수업이었어요. 큰 틀은 정해져있었던 강의지만, 강의 때 나왔던 질문들을 바탕으로 보충 영상도 올려주시고, 스타터키트도 업데이트 해가시는 모습을 보며 이걸 선택하길 참 잘했다는 생각이 들었습니다. 사실 바이브코딩 강의가 너무 많아서 어떤걸 들어야했는지 고민됐었는데, 선생님이랑 스레드랑 인스타에서 길게 dm으로 상담하고 선택한 강의었던지라, 더더욱 열심히 들었던 것 같아요.',
    recommender: 'Data Driven Design 대표 DDD',
  },
  {
    name: '윤XX',
