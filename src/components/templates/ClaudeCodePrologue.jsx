  ...
  return (
    <>
      <IcebergSection
        ...
        isMinHeight
        sx={{
          bgcolor: `${CC.orange} !important`,
          color: `${CC.black} !important`,
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        {/* 회전 Claude 로고 — 배경 워터마크 */}
        <Box
          sx={{
            position: 'absolute',
            top: '50%',
        ...
        <Box sx={{ position: 'relative' }}>
          <Typography
            variant="overline"
            sx={{ color: 'rgba(0,0,0,0.5)', display: 'block', mb: 3 }}
          >
            {PROLOGUE.date}
          </Typography>
          ...
          <Typography
            variant="h1"
            sx={{ color: CC.black, mb: { xs: 4, md: 6 } }}
          >
            {PROLOGUE.headline}
          </Typography>
          ...
          <Typography
            variant="body1"
            sx={{ color: 'rgba(0,0,0,0.6)', maxWidth: 720, mb: 3 }}
          >
            {PROLOGUE.body}
          </Typography>
        </Box>
