...
export const DesignAsBuildIso = (props) => {
  const layers = LAYERS.map((l, i) => {
    ...
    return { ...l, p, nl, nlColor, legendTitleY };
  });
  ...
  // Bottom annotations (pre-computed from IIFE)
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={W} height={H} fill="none" viewBox={`0 0 ${W} ${H}`} {...props}>
      ...
      <g data-role="annotations">
        ...
        {/* Bottom Annotations */}
        <g data-part="bottom-annotations">
        ...
        <g data-part="decorative" transform="translate(10, 374)">
